...
export default function Dhikrs() {
  return (
    <>
      <Head>
      <title>Dhikrs</title>
            ...
            <div className="row course-description">
              <div className="col-xl-10 col-lg-10">
                <div className="project-details mb-65">
                  <h2 className="courses-title mb-30 text-center">Dhikrs</h2>
                  <p className="text-center">Allah (سبحانه وتعالى ) says,</p>
                  <br />

                  <p className="text-center">
                    <strong>
                      {" "}
                      يَـٰٓأَيُّہَا ٱلَّذِينَ ءَامَنُواْ ٱذۡكُرُواْ ٱللَّهَ
                      ذِكۡرً۬ا كَثِيرً۬ا{" "}
                    </strong>
                  </p>
                  <br />
                  ...
                  <p className="mb-45 text-justify">
                    Dhikrs also includes remembering Allah when one gets up in
                    the morning, on starting to do anything, on eating, leaving
                    the house, on entering various places and before performing
                    so many other activities. Our Prophet (SAW) has taught us
                    the appropriate supplications for every occasion and if we
                    can recite these with understanding, all our activities
                    will, In Shaa Allah, amount to His remembrance and worship.
                    Dhikrs and Supplications or Duas for kids include day to day
                    supplications of eating, sleeping, after waking up, entering
                    and leaving the toilet, entering and leaving the house, etc.
                    Through this we aim to inculcate in child the habit of
                    remembering Allah in most of the things that he / she does.
                    It will also enhance the child&apos;s eeman and love towards
                    his Rabb.
                  </p>
                  <h5 className="mb-25">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="z-gallery mb-30">
                  ...
                  <div className="z-gallery__content">
                    <Link href="/quranic-stories">
                      <a>
                        <h4 className="sub-title text-center mb-20">
                          Quranic Stories
                        </h4>
                      </a>
                    </Link>
