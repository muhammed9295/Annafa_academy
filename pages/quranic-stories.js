  ...
  return (
    <>
      ...
      <main className="pt-180 pb-100 pb-xs-50">
        ...
        <PageHeader title="Quranic Stories" />
        {/*page-title-area end*/}
            ...
            <div className="row course-description">
              <div className="col-xl-10 col-lg-10">
                <div className="project-details mb-65">
                  <h2 className="courses-title mb-30 text-center">
                    Quranic Stories
                  </h2>
                  <p className="mb-45 text-justify">
                    To make learning and memorizing Qur&apos;an more interesting we
                    bring a series of Qur&apos;anic stories to the syllabus which
                    will help child bulid strong connection with the Qur&apos;an.
                    Children will be taught some of the prophetic stories from
                    the Qur&apos;an in an interactive way so that they imbibe these
                    lessons from the Qur&apos;an into their lives. Some of the
                    stories include the story of Prophet Nuh, prophet Ibrahim,
                    story of the cave, and so on. This class will be once a
                    month ان شاء الله
                  </p>
                  <h5 className="mb-25">
